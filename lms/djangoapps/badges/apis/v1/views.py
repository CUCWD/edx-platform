...
class UserBadgeProgressListView(DeveloperErrorViewMixin, APIView):
    ...
    **Returns**
    ...
    def get(self, request, username, course_id, *args, **kwargs):  # pylint: disable=unused-argument
        """
            ...
            progress_to_show.append(
                {
                    ...
                    "assertion": {
                        "image_url": (
                            block_event_assertion.image_url if block_event_assertion else ""
                            ),
                        "assertion_url": (
                            block_event_assertion.assertion_url if block_event_assertion else ""
                            ),
                    },
                }
            )
