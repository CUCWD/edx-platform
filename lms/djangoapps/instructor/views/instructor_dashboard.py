...
def _section_student_admin(course, access):
    ...
    settings_writable_gradebook_url = configuration_helpers.get_value('WRITABLE_GRADEBOOK_URL', settings.WRITABLE_GRADEBOOK_URL)
    if is_writable_gradebook_enabled(course_key) and settings_writable_gradebook_url:
        section_data['writable_gradebook_url'] = f'{settings_writable_gradebook_url}/{str(course_key)}'
    return section_data
