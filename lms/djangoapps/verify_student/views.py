...
def results_callback(request):  # lint-amnesty, pylint: disable=too-many-statements
    ...
    if result == "PASS":
        ...
        settings_account_microfrontend_url = configuration_helpers.get_value('ACCOUNT_MICROFRONTEND_URL', settings.ACCOUNT_MICROFRONTEND_URL)
        reverify_url = f'{settings_account_microfrontend_url}/id-verification'
