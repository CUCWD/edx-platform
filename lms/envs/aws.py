...
FEEDBACK_TROUBLESHOOTING_GUIDE = ENV_TOKENS.get("FEEDBACK_TROUBLESHOOTING_GUIDE")
...
CONTACT_FORM_SUBMISSION_BACKEND = ENV_TOKENS.get("CONTACT_FORM_SUBMISSION_BACKEND")
...
BADGR_PUBLIC_URL = ENV_TOKENS.get('BADGR_PUBLIC_URL', BADGR_PUBLIC_URL)
