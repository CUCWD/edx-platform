...
#                         xblock.force_save_fields(['estimated_time'])
#                         print(xblock.fields)
#                         print(xblock.estimated_time)
