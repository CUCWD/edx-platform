...
urlpatterns = oauth2_urlpatterns + [
    ...
    url(fr'^assets/{settings.COURSE_KEY_PATTERN}/{settings.ASSET_KEY_PATTERN}?$',
        ...
        name='assets_handler'),
    url(fr'^assets/{settings.COURSE_KEY_PATTERN}/{settings.ASSET_KEY_PATTERN}/usage',
    ...
    url(fr'^textbooks_api/{settings.COURSE_KEY_PATTERN}$', contentstore_views.textbooks_list_api_handler,
        name='textbooks_list_api_handler'),
    url(fr'^textbooks_api/{settings.COURSE_KEY_PATTERN}/(?P<textbook_name>[^/]*)$',
