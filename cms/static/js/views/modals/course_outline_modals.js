...
define(['jquery', 'backbone', 'underscore', 'gettext', 'js/views/baseview',
    ...
    SettingsXBlockModal = CourseOutlineXBlockModal.extend({
        ...
        getTitle: function() {
            return StringUtils.interpolate(
                ...
                gettext('TEST: {display_name} Settings'),
    ...
    // The EstimatedTimeEditor allows course authors to set an estimated time for a section, which is the amount of time 
    // a learner would likely need to complete the section. It also allows course authors to specify whether to show the 
    // estimated time to learners and whether to override the estimated time for subsections.
    EstimatedTimeEditor = AbstractEditor.extend({
        ...
        isCourseShowEstimatedTimeEnabled: false,
        ...
        afterRender: function() {
            ...
            this.isCourseShowEstimatedTimeEnabled = this.model.get('course_show_estimated_time') === true;
            ...
            if (this.isCourseShowEstimatedTimeEnabled) {
                this.$('#show_estimated_time').prop('checked', true);
                this.$('#show_estimated_time').prop('disabled', true);
                this.$('#course_show_estimated_time_message').show();
            } else {
                this.$('#course_show_estimated_time_message').hide();
            }
        },
        ...
        getRequestData: function() {
            ...
            var showEstimatedTimeValue = this.isCourseShowEstimatedTimeEnabled
                ? true
                : (this.$('#show_estimated_time').prop('checked') ? true : false);
            ...
            if (JSON.stringify(newEstimatedTime) === JSON.stringify(this.defaultEstimatedTime)
                ...
                && this.startVisibilityVal === showEstimatedTimeValue) {
                return {};
            }
            var requestData = {
                metadata: {
                    ...
                    show_estimated_time: showEstimatedTimeValue,
                }
            };
            return requestData;
        }
    ...
    return {
        ...
        getEditModal: function(xblockInfo, options) {
            ...
            if (xblockInfo.isVertical()) {
                editors = [StaffLockEditor, EstimatedTimeEditor, UnitAccessEditor, DiscussionEditor];
